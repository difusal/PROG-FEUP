...
void AddMusicState::Initialize()
{
	...
	availability = 1;
	availability_box_checked = true;
}

bool AddMusicState::Update(ALLEGRO_EVENT * ev)
{
	...
	if (submit)
	{
		...
		{
			cout << "Adding music right now..." << endl;
			StateControl::GetInstance()->radio.AddMusic(title_str, artist_str, author_str, album_str, genre_str, year_str, availability);
...
bool AddMusicState::AllFormsInactive()
{
...
void AddMusicState::DeactivateAllForms()
{
